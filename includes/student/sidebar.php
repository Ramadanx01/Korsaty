...
<div class="sidebar d-flex flex-column">
    <div class="logo-container">
        <a href="<?php echo url_for('student-dashboard.php'); ?>">
            <img src="<?php echo asset('images/logo.png'); ?>" alt="شعار Korsaty">
        </a>
    </div>
    <ul class="nav flex-column mb-auto">
        <li class="nav-item">
            <a class="nav-link <?php echo ($current_page === 'student-dashboard.php' ? 'active' : ''); ?>" href="<?php echo url_for('student-dashboard.php'); ?>">
                <i class="fas fa-tachometer-alt me-2"></i>الرئيسية
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo ($current_page === 'student-courses.php' ? 'active' : ''); ?>" href="<?php echo url_for('student-courses.php'); ?>">
